...
#define SOS_BOARD_USART1_TX_PORT 0
#define SOS_BOARD_USART1_TX_PIN 9
#define SOS_BOARD_USART1_RX_PORT 0
#define SOS_BOARD_USART1_RX_PIN 10

#define SOS_BOARD_UART4_TX_PIN 2, 10
#define SOS_BOARD_UART4_RX_PIN 2, 11

#define SOS_BOARD_UART5_TX_PIN 2, 12
#define SOS_BOARD_UART5_RX_PIN 3, 2

#define SOS_BOARD_I2C1_SDA_PORT 1
#define SOS_BOARD_I2C1_SDA_PIN 6
#define SOS_BOARD_I2C1_SCL_PORT 1
#define SOS_BOARD_I2C1_SCL_PIN 7
...
//SPI1
#define SOS_BOARD_SPI1_MISO_PIN 0, 6
#define SOS_BOARD_SPI1_MOSI_PIN 0, 7
#define SOS_BOARD_SPI1_SCK_PIN 0, 5
#define SOS_BOARD_SPI1_CS_PIN 0xff, 0xff

//shared with UART4 and 5
#define SOS_BOARD_SPI3_MISO_PIN 2, 11
#define SOS_BOARD_SPI3_MOSI_PIN 2, 12
#define SOS_BOARD_SPI3_SCK_PIN 2, 10
#define SOS_BOARD_SPI3_CS_PIN 0xff, 0xff
